...
TEST_CASE("Verify vector val, ref, and const params")
{
	vector<int> n1{0,1,2};
	vector<int> n2{0,1,2};
	vector<int> n3{0,1,2};
...
TEST_CASE("Verify vector val param")
{
	vector<int> v1{1,2,3};
...
TEST_CASE("Verify vector ref param")
{
	vector<int> v1{1,2,3};
	vector<int> v1_expected {1,2,3};
...
TEST_CASE("Verify vector ref param for ranged")
{
	vector<int> v1{1,2,3};
	vector<int> v1_expected {-1,-1,-1};
	iterate_vector_ref_param_for_ranged(v1);
